...
class IsGitHubActionDefinitionTest implements RewriteTest {

    @Override
    public void defaults(RecipeSpec spec) {
        spec.recipe(new IsGitHubActionDefinition());
    }
          ...
          yaml(
            ...
            """
              runs:
                using: composite
              """,
            spec -> spec.path(".github/actions/build/action.yaml")
              .afterRecipe(docs -> assertThat(docs.getMarkers().findFirst(SearchResult.class)).isPresent())
          )
        );
    }
              ...
              yaml(
                """
                  runs:
                    using: composite
                  """,
                spec -> spec.path(".github/actions/build/composite.yml")
