...
class SetupPythonUpgradePythonVersionTest implements RewriteTest {
    ...
    @Test
    void doubleQuotedVersionPreservesStyle() {
        rewriteRun(
                yaml(
                        """
                        name: CI
    ...
    @Test
    void upgradePlainNumericYamlScalar() {
        rewriteRun(
                yaml(
                        """
                        name: CI
    ...
    @Test
    void upgradeSafelyOlderLessThanOrEqualRangeAndXRange() {
        rewriteRun(
                yaml(
                        """
                        name: CI
    ...
    @Test
    void upgradeSafelyOlderTildeAndMajorXRanges() {
        rewriteRun(
                yaml(
                        """
                        name: CI
